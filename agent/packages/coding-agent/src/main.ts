...
export async function main(args: string[]) {
	...
	// Non-interactive solver runs benefit from brief reasoning before tool calls.
	// Default to "low" thinking to improve edit accuracy without excessive latency.
	if (!isInteractive && parsed.thinking === undefined && !cliThinkingFromModel) {
		sessionOptions.thinkingLevel = "low";
	}
